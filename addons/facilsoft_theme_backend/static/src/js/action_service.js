...
export function makeActionManager(env, router = _router) {
    ...
    // SPIFFY MULTI TAB START
    function updatefacilsoftTabDetails(tabId, ActionId, controller) {
    ...
    async function _updateUI(controller, options = {}) {
        ...
        if (controller.action.id){
            ...
            /* if($(menu_xmlid).length){
                updatefacilsoftTabDetails(tabID, UpdateAction, controller);
            } */
        ...
        controller.config.historyBack = () => {
         ...
         // SPIFFY MULTI TAB START
         sessionStorage.setItem("facilsoft_current_action", action._originalAction);
         sessionStorage.setItem("facilsoft_current_action_id", action.id);
         // SPIFFY MULTI TAB END
