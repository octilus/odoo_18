...
import body_color from "@facilsoft_theme_backend/js/menu";
...
patch(NavBar.prototype, {
    ...
    _searchMenuItems: function(ev){
        ...
        var results = this.state.hasResults
            ...
            : [];
        // TODO: qweb render
        $(".appdrawer_section #search_result").empty().append(renderToFragment("facilsoft_theme_backend.MenuSearchResults", {
                results: results,
                widget: this,
            })
        );
