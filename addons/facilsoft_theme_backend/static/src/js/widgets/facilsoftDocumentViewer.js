...
export class facilsoftDocumentViewer extends Widget {
    static template = "facilsoftDocumentViewer";
    /**
     ...
     */
    _updateContent (e) {
        var newRender = renderToElement('facilsoftDocumentViewer.Content', {
            widget: this,
        });
