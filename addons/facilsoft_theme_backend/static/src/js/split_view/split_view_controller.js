...
export class SplitViewController extends FormController {
    ...
    getActionMenuItems() {
        ...
        $('.facilsoft_list_view > .o_list_renderer .o_data_row[resid="'+this.props.resId+'"]').addClass('side-selected')
        return ActionMenuItems;
    }

}
// [T2304] Commented due to v18 ControlPanel structure change, replaced by new XPath.
// SplitViewController.template = 'facilsoft_split_view.SplitViewForm';
