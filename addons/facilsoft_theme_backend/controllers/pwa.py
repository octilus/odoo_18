...
class PwaMain(http.Controller):
    ...
    def service_worker(self):
        ...
        content = qweb._render('facilsoft_theme_backend.service_worker', {
    ...
    def pwa_offline(self, **kw):
        return request.render('facilsoft_theme_backend.pwa_offline_page',)

    @http.route('/facilsoft_theme_backend/<int:company_id>/manifest.json', type='http', auth="public")
