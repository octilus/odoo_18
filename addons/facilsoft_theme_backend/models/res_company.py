...
class Company(models.Model):
    ...
    tab_name = fields.Char(string="Backend Tab Name", default="facilsoft", readonly=False)
    ...
    facilsoft_favicon = fields.Binary(string="Backend Tab Favicon", readonly=False)
    ...
    app_name_pwa = fields.Char('App Name', readonly=False, default='facilsoft')
    short_name_pwa = fields.Char('Short Name', readonly=False, default='facilsoft')
    description_pwa = fields.Char('App Description', readonly=False, default='facilsoft')
    ...
    facilsoft_toobar_color = fields.Char('Toolbar Color', readonly=False, default='#1B1B1B')
    ...
    def _get_firebase_records(self):
        json_path = file_path('facilsoft_theme_backend/static/description/firebase-key/facilsoft-99038-firebase-adminsdk-tmssr-ac7b5e49a3.json')
