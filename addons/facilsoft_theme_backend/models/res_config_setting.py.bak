...
class ResConfig(models.TransientModel):
    ...
    facilsoft_favicon = fields.Binary(
        related='company_id.facilsoft_favicon', string="Backend Tab Favicon", readonly=False)
    ...
    facilsoft_toobar_color = fields.Char('Toolbar Color', related='company_id.facilsoft_toobar_color', readonly=False)
    ...
    #         json_path = file_path('facilsoft_theme_backend/static/description/firebase-key/facilsoft-99038-firebase-adminsdk-tmssr-26241eaaa2.json')
