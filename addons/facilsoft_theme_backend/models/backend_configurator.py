...
class BackendConfig(models.Model):
    _name = 'facilsoft.backend.configurator'
    _description = "Configurator Backend Theme"

    def _default_app_drawer_bg_image(self):
        image_path = file_path('facilsoft_theme_backend/static/description/app-drawer-bg-image.png')
        with tools.file_open(image_path, 'rb') as f:
            return base64.b64encode(f.read())

    def _default_vertical_mini_bg_image_one(self):
        image_path = file_path('facilsoft_theme_backend/static/description/topbar-bg.jpg')
        with tools.file_open(image_path, 'rb') as f:
            return base64.b64encode(f.read())
    ...
    def _default_menu_bg_image(self):
        image_path = file_path('facilsoft_theme_backend/static/description/header_vertical_mini.svg')
        with tools.file_open(image_path, 'rb') as f:
            return base64.b64encode(f.read())
    ...
    header_vertical_mini_text_color = fields.Char(string="App Header Custom Text Color",default="#1B1263")
    ...
    light_primary_bg_color = fields.Char(string="Primary Background Color for light",default="#1B1263")
    ...
    dark_primary_bg_color = fields.Char(string="Primary Background Color for dark",default="#1B1263")
    ...
    top_menu_position = fields.Selection([
        ...
        default="top_menu_vertical_mini_2", string="Top Menu Position")
